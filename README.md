...
*   🎥 **Video Training:** [Microsoft Dynamics 365 Contact Center Video Training](https://powerpete.com/microsoft-dynamics-365-contact-center-video-training/) by MVP Peter (Power Pete).
*   📊 **Visual Diagram:** [PSTN Voice Flow Diagram](https://voice-flow.demo-monkey.net/) to understand options for connecting the PSTN voice channel.
